...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OnboardingSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13OnboardingSDK18KDCircularProgress")
...
@interface UIColor (SWIFT_EXTENSION(OnboardingSDK))
...
@property (nonatomic, readonly) BOOL isWhiteText;
@end
...
@interface UIImage (SWIFT_EXTENSION(OnboardingSDK))
...
@interface UIImageView (SWIFT_EXTENSION(OnboardingSDK))
